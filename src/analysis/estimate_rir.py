...
def estimate_rir_from_curve(current_set_reps: list[RepMetric], model: np.poly1d) -> float:
    ...
    v = np.array([rep.mean_concentric_speed_ms for rep in current_set_reps], dtype=float)
